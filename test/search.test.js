...
describe("search", () => {
    ...
    describe("buildScheduleQueries", () => {
        ...
        it("builds queries without site parameter for invalid URL", () => {
            ...
            expect(queries).toEqual([" schedule", " agenda", " program", " speakers", " timetable"].filter(Boolean));
        });
    ...
    describe("searchWeb", () => {
        describe("provider selection", () => {
            it("uses tavily when explicitly specified and key exists", async () => {
                ...
                expect(mockAxios.post).toHaveBeenCalledWith("https://api.tavily.com/search", {
